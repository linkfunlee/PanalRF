...
package com.netease.nim.demo.lesRf.baidumaputil.clusterutil.clustering.algo;
...
import com.netease.nim.demo.lesRf.baidumaputil.clusterutil.projection.Bounds;
...
import com.netease.nim.demo.lesRf.baidumaputil.clusterutil.quadtree.PointQuadTree;
...
public class NonHierarchicalDistanceBasedAlgorithm<T extends ClusterItem> implements Algorithm<T> {
    ...
    public Set<? extends Cluster<T>> getClusters(double zoom) {
        ...
        final Map<QuadItem<T>, com.netease.nim.demo.lesRf.baidumaputil.clusterutil.clustering.algo.StaticCluster<T>> itemToCluster =
                new HashMap<QuadItem<T>, com.netease.nim.demo.lesRf.baidumaputil.clusterutil.clustering.algo.StaticCluster<T>>();
        ...
        synchronized (mQuadTree) {
            for (QuadItem<T> candidate : mItems) {
               ...
               com.netease.nim.demo.lesRf.baidumaputil.clusterutil.clustering.algo.StaticCluster<T> cluster =
                        new com.netease.nim.demo.lesRf.baidumaputil.clusterutil.clustering.algo
