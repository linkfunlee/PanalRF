...
public final class ServiceManager {
    ...
    public ServiceManager(Context context) {
        ...
        xmppHost = props.getProperty("xmppHost", "172.16.0.65");
        xmppPort = props.getProperty("xmppPort", "8030");
        Log.e(LOGTAG, "apiKey=" + apiKey);
        Log.e(LOGTAG, "xmppHost=" + xmppHost);
        Log.e(LOGTAG, "xmppPort=" + xmppPort);
    ...
    public void startService() {
        Thread serviceThread = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                intent.setAction(".lesRf.client.NotificationService");//你定义的service的action
                intent.setPackage("com.netease.nim.demo");//这里你需要设置你应用的包名
    ...
    private Properties loadProperties() {
        ...
        try {
            ...
            props.load(context.getResources().openRawResource(R.raw.androidpn));
