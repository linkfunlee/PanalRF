...
public class BDBNaviGuideActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View view = mNaviHelper.onCreate(BDBNaviGuideActivity.this);
        if (view != null) {
            setContentView(view);
        }

        mNaviHelper.startBikeNavi(BDBNaviGuideActivity.this);
