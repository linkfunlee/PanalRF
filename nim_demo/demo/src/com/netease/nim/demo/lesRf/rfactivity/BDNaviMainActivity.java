...
public class BDNaviMainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.les_map_navguider);
        requestPermission();
        ...
        startPt = Config.mCurrentPosition;//new LatLng(40.047416,116.312143);
        endPt = Config.mendPosition;//new LatLng(40.048424, 116.313513);


       // startWalkNavi();//llf added start walk
    ...
    private void initMapStatus(){
       ...
       // builder.target(new LatLng(40.048424, 116.313513)).zoom(19);
        builder.target(Config.mCurrentPosition).zoom(19);
    ...
    private void routePlanWithParam() {
        mNaviHelper.routePlanWithParams(param, new IBRoutePlanListener() {
            ...
            public void onRoutePlanSuccess() {
                ...
                intent.setClass(BDNaviMainActivity.this, BDBNaviGuideActivity.class);
    ...
    private void routePlanWithWalkParam() {
        mWNaviHelper.routePlanWithParams(walkParam, new IWRoutePlanListener() {
            ...
            public void onRoutePlanSuccess() {
                Log.d("View", "onRoutePlanSuccess");
                Intent intent = new Intent();
                intent.setClass(BDNaviMainActivity.this, BDWNaviGuideActivity.class);
                startActivity(intent);
            }
