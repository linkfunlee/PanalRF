...
public class XmppManager {
    ...
    public XmppManager(NotificationService notificationService) {
        ...
        xmppHost = sharedPrefs.getString(Constants.XMPP_HOST, "172.16.0.65");
        xmppPort = sharedPrefs.getInt(Constants.XMPP_PORT, 8030);
            ...
            if (!xmppManager.isConnected()) {
                ...
                try {
                    ...
                    ProviderManager.getInstance().addIQProvider("notification",
                            ...
                            new NotificationIQProvider());//llf added
                    xmppManager.runTask();
