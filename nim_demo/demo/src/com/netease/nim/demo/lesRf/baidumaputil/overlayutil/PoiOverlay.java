package com.netease.nim.demo.lesRf.baidumaputil.overlayutil;
        ...
        for (int i = 0; i < mPoiResult.getAllPoi().size()
            ...
            if (IconFlag==0) {
                markerList.add(new MarkerOptions()
                        .icon(BitmapDescriptorFactory.fromResource(R.drawable.rfgc)).extraInfo(bundle)
                        .position(mPoiResult.getAllPoi().get(i).location));
            }
            else if(IconFlag==1)
            {
                markerList.add(new MarkerOptions()
                        .icon(BitmapDescriptorFactory.fromResource(R.drawable.parking)).extraInfo(bundle)
                        .position(mPoiResult.getAllPoi().get(i).location));
            }
