...
public class HomeFragment extends TFragment implements OnPageChangeListener, ReminderManager.UnreadNumChangedCallback {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.main, container, false);//这里是加载控件
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        options.titleId = R.string.my_rf;
        setToolBar(R.id.toolbar, options);


      //  setToolBar(R.id.toolbar, R.string.my_rf, R.drawable.actionbar_dark_logo);


       // setTitle(R.string.my_rf);
        //setTitle("我的人防");
