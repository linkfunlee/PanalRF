...
public class MainActivity extends UI {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LogUtil.e(TAG, "sync completed = " + syncCompleted);
        if (!syncCompleted) {
            DialogMaker.showProgressDialog(MainActivity.this, getString(R.string.prepare_data)).setCanceledOnTouchOutside(false);
        }

        onInit();
        LogUtil.e(TAG, "sync RFappHomeActivity = " + syncCompleted);
      // RFappHomeActivity.start(this);
        LogUtil.e(TAG, "sync RFappHomeActivity after = " + syncCompleted);
       // startActivity(new Intent(MainActivity.this, RFappHomeActivity.class));
    }
    ...
    public void onBackPressed() {
        if (mainFragment != null) {
            ...
            //super.onBackPressed();
            RFappHomeActivity.start(this);// llf added
            finish();
        }
    }
